<template>
    <div>
        <div id="p1">
            In diesem Spiel geht es darum, Kopfrechenaufgaben zu lösen und dabei Punkte zu sammeln.        
        </div>
        <div id="coin_svg">
        ...
        <div id="p2">
            Um eine Mission zu schaffen, musst du in 2 Minuten eine bestimmte Punktzahl erreichen.     
        </div>
        <div id="p3">
            <span>Die Schwierigkeit der Aufgaben passt sich an dich an.</span>
        </div>
